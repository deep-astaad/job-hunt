...
ROLES = [
    "Backend Engineer", "Software Engineer", "Python Developer", "Backend Developer",
    "Platform Engineer", "Cloud Engineer", "DevOps Engineer", "AWS Engineer",
    "Site Reliability Engineer", "Full Stack Engineer", "Data Engineer", "AI Engineer",
]
...
def _linkedin_url(keyword, loc_cfg, append_english):
    ...
    return (
        ...
        f"&f_TPR={_LINKEDIN_TPR}&position=1&pageNum=0"
    )
...
def _linkedin_config(loc_cfg):
    ...
    return {
        ...
        "input": {
            ...
            "splitCountry": loc_cfg.get("country", "") or "US",
            "urls": urls,
